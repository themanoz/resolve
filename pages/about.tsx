...
export default function About() {
  return (
    <div className="h-[40rem] w-full pt-24 rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
      {/* <Spotlight
